...
public interface UserRepo extends JpaRepository<User,Long> {
    ...
    //note findBy method entity return kare so make sure apde @Query na madad thi apde apdi jate query lakhiee ke su joiee che
   ...
   // @Query("SELECT u.userId FROM User u WHERE u.providerSub = :providerSub")
    //Optional<Long> findUserIdByProviderSub(@Param("providerSub") String providerSub );
